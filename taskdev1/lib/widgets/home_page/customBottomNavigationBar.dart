      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return index == 2
                  ...
                  onTap: () {
                    showModalBottomSheet(
                        ...
                        builder: (BuildContext context) {
                          return const TestPage(); //Widget From another File
                        });
                  },
                  child: Container(
              ...
              : Container(
                  margin: index != 4 ? const EdgeInsets.only(right: 30) : null,
                  height: 40,
                  width: 45.87,
                  child: Center(
                    child: Image.asset(
                      bottomVavigationBarImagesList[index],
                      fit: BoxFit.fill,
                    ),
                  ),
                );
            ...
            children: <Widget>[
              ...
              if (itemsMoved)
                Container(
                  ...
                  child: TextFormField(
                    ...
                    autofocus: true,
                    onChanged: (val) {
                      int lengthWithoutSpaces = val.replaceAll(' ', '').length;
                      setState(() {
                        if (lengthWithoutSpaces >= 0 &&
                          ...
                          maxLines = 8;
                        } else if (lengthWithoutSpaces >= 407 &&
                            lengthWithoutSpaces <= 457) {
                          maxLines = 7;
                        } else if (lengthWithoutSpaces >= 458 &&
                            lengthWithoutSpaces <= 608) {
                          maxLines = 8;
                        }
                      });
                    },
              ...
              fileCamera != null
                  ? Container(
                      ...
                      child: ClipRRect(
                        borderRadius:
                            BorderRadius.circular(20), //تجعل خواف الصورة دائرية
                        child: Image.file(
                          fileCamera!,
                          fit: BoxFit.fill,
                        ),
